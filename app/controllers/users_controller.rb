class UsersController < ApplicationController
  ...
  def user_params
    params.require(:user).permit(:firstname, :lastname, :display_name, :email, :password, :password_confirmation, :instagram, :facebook, :twitter, :website, :bio, :marketing_consent)
  end
