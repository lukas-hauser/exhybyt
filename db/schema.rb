...
ActiveRecord::Schema.define(version: 20_210_504_202_530) do
  ...
  create_table 'artworks', force: :cascade do |t|
    ...
    t.index ['subject_id'], name: 'index_artworks_on_subject_id'
  ...
  create_table 'spaces', force: :cascade do |t|
    ...
    t.index %w[user_id created_at], name: 'index_spaces_on_user_id_and_created_at'
  ...
  add_foreign_key 'artworks', 'subjects'
